...
export default async function AnalyticsPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    try {
        ...
        try {
            ...
            if (data) {
                storyData = data
                totalStoryViews = data.reduce((acc: number, curr: any) => acc + (curr.view_count || 0), 0)
            }
        } catch (e) {
                    ...
                    <div className="max-w-7xl mx-auto space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <StatsCard
                                ...
                                trend={storyData.length > 0 ? `${storyData.length} stories` : undefined}
                                trendLabel="active"
                            />
                        </div>
                        ...
                        <Card className="border-2 border-gray-100 shadow-xl">
                            ...
                            <CardContent className="pt-6">
                                <div className="space-y-4">
                                    {storyData?.slice(0, 5).map((story: any) => (
                                        <div key={story.id} className="flex items-center gap-4 p-3 rounded-lg hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100">
                                            ...
                                            <div className="flex items-center gap-1.5 text-sm font-semibold text-gray-700 bg-gray-100 px-2 py-1 rounded-md">
                                    ...
                                    {(!storyData || storyData.length === 0) && (
                                        <p className="text-sm text-gray-500 text-center py-4">No stories posted yet.</p>
                                    )}
                                </div>
                            </CardContent>
                        </Card>
